  ...
  const features = [
    {
      ...
      description: "Our fleet of scooters are regularly serviced and sanitized for your comfort and safety.",
    },
    {
      icon: Clock,
      title: "Flexible Rentals",
      description: "Rent by the hour or day. Perfect for quick errands or full-day Mumbai exploration.",
    },
    {
      icon: Shield,
      title: "Fully Insured",
