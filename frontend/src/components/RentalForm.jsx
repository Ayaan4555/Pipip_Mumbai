...
const rentalSchema = z.object({
  ...
  pickupLocation: z
    .string()
    .trim()
    .min(5, "Please enter a valid pickup location")
...
const RentalForm = () => {
 ...
 const handleSubmit = async (e) => {
   ...
   toast({
      ...
      description: "We have received your request. We will contact you shortly.",
    });
  } catch (error) {
      ...
      ${errors.date ? "border-destructive" : "border-input"}`}
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="monthly">Monthly - ₹9000</option>
              </select>
              {errors.duration && (
