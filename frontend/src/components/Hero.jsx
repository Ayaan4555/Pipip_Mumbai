...
//               <li key={index} className="flex items-center gap-3 text-lg text-foreground/90">
...
useEffect(() => {
  const getServer = async () => {
    try {
      await axios.get("https://pipip-backend-eid3.onrender.com/api/rentals");
    } catch (err) {
          ...
          >
            ...
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 shadow-2xl">
              ...
              <Button
                ...
                className="w-full gradient-sunset text-black font-semibold py-6 rounded-xl shadow-lg hover:shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
